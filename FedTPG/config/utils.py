...
def reset_cfg(cfg, args):
    ...
    if args.exp_name == "cross_data":
        ...
        # cfg.DATASET.NAME_SPACE = ['oxford_flowers', 'fgvc_aircraft', 'ucf101', 'oxford_pets', 'food101', 'dtd', 'sun397']
        ...
        # cfg.DATASET.TESTNAME_SPACE = ['oxford_flowers', 'fgvc_aircraft', 'ucf101', 'oxford_pets', 'food101', 'dtd', 'sun397']
