...
class BrainTumor(DatasetBase):
    dataset_dir = "brain_tumor"

    def __init__(self, cfg, nclients=4, iid=False):
        """
        Args:
        ...
        self.train_dir = os.path.join(self.dataset_dir, "Training")
        self.test_dir = os.path.join(self.dataset_dir, "Testing")
